...
<style type="text/css">
  ...
  /* Edit Cover Button (Initially Hidden) */
  .edit-cover {
    position: absolute;
    bottom: 10px;
    right: 10px;
...
<body>
  ...
  <main>
    <?php
    //   var_dump('<pre>',$_SESSION,$_SERVER['REQUEST_URI'],$point);
    ...
    <button class="edit-cover">Edit Cover</button>
        ...
        <i class="bi bi-camera"></i> Edit Cover Photo
                ...
                <button class="edit-cover" onclick="document.getElementById('coverUpload').click();">
                  <i class="bi bi-camera"></i> Edit Cover Photo
                </button>
              ...
              <div class="card-body profile-info text-center">
                <!-- User Name & Bio -->
                <h2 class="username"><?= ucfirst($user['name']) ?></h2>
                <h3 class="bio">############</h3>
