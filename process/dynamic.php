...
// var_dump('<pre>', $_POST, $user, $_SESSION);
switch ($hjob) {
    case 'tosave':
    ...
    case 'toedit':
        break;
    case 'toCreatePosting':
        echo toCreatePosting($txtPosting, $content, $userId);
        break;
}

function toCreatePosting($txtPosting, $content, $userId ) {
    $connection = getDbConnection();
    $stmt = $connection->prepare("INSERT INTO posts (user_id, content, title) VALUES (?,?,?)");
    $stmt->bind_param("iss", $userId, $content, $txtPosting);
}
